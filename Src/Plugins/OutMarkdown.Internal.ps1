            ...
            process {
                ...
                foreach ($s in $Section.Sections.GetEnumerator()) {
                    ...
                    switch ($s.Type) {
                        ...
                        'PScribo.Paragraph' { [ref] $null = $sectionBuilder.Append(($s | OutMarkdownParagraph)); }
                        'PScribo.PageBreak' { [ref] $null = $sectionBuilder.AppendLine((OutMarkdownPageBreak)); }  ## Page breaks implemented as line break with extra padding
                        'PScribo.LineBreak' { [ref] $null = $sectionBuilder.AppendLine((OutMarkdownLineBreak)); }
                        'PScribo.Table' { [ref] $null = $sectionBuilder.AppendLine(($s | OutMarkdownTable)); }
                        'PScribo.BlankLine' { [ref] $null = $sectionBuilder.AppendLine(($s | OutMarkdownBlankLine)); }
        ...
        } #end function OutMarkdownsection
        ...
        } #end function OutMarkdownLineBreak
        ...
        #>
            ...
            param ( )
            process {
                return "$(OutMarkdownLineBreak)`r`n";
            } #end process
        } #end function OutMarkdownLineBreak
        ...
        #endregion OutMarkdown Private Functions
